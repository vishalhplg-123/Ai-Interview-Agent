...
import techImag from "../assets/tech.png" 
        ...
        <div className='max-w-6xl mx-auto'>
         <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <HiSparkles className='bg-green-50 text-green-600 '/>
          ...
          <div className='text-center mb-28'>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10 ">
                 <motion.button
                    ...
                    className=' px-10 py-3 bg-black text-white transition rounded-full hover:opacity-90 shadow-md'
                 >
                  Start Interview
                 </motion.button>
                 <motion.button
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                },
                {
                  ...
                  desc: "Dynamic follow-up qeustion based on your answers."
                },
                {
                ...
                return(
                  <motion.div key={index}
                   ...
                   className={`
                    relative bg-white rounded-3xl border border-green-100 hover:border-green-500 p-10 w-80 max-w-[98%] shadow-md hover:shadow-2xl
                  ...
                  `}>
                    ...
                    <div className='absolute -top-8 left-1/2  -translate-x-1/2 bg-white border-2 border-green-500  text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-xl'>
                      {item.icon}
                    </div>     
