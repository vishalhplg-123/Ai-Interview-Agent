  ...
  const plans = [
    {
      ...
      features: [
        ...
        "Basic Performances Report",
        "Voices Interview Access",
    ...
    },
    {
      ...
      price: "₹100",
      credits: 150,
      description: "Great for focused praactice and skill improvement.",
      features: [
                  ...
                  !plan.default && 
                    <button
                     ...
                     className={`w-full mt-8 py-3 rounded-xl font-semibold transition ${isSelected ? "bg-emerald-600 text-white hover:opacity-90 ": "bg-gray-100 text-gray-700 hover:bg-emerald-50"}`}>
                      {
                        loadingPlan === plan.id ? "Processing..." : isSelected ? "Prceed to Pay" : "Select Plan"
                      }
                    </button>
                 }
