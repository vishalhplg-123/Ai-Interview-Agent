...
const Step2Interview = ({ interviewData, onFinish }) => {
  ...
  const speakText = (text) => {
    return new Promise((resolve) => {
      ...
      const ulterance = new SpeechSynthesisUtterance(humanText);
      ulterance.voice = selectedVoice;

      //human-like pacing
      ulterance.rate = 0.92; //slightly slower than normal
      ulterance.pitch = 1.05; //small warmth
      ulterance.volume = 1;
      ...
      setSubtitle(text);
      window.speechSynthesis.speak(ulterance);
    });
  };
         ...
         {!isIntroPhase && <div className="relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm">
          ...
          { !feedback ? (<div className="flex items-center gap-4 mt-6">
            ...
            <motion.button
              ...
              className="flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 sm:py-4 rounded-2xl
